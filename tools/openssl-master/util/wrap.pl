...
BEGIN {
    ...
    require '/home/javds/Desktop/betterDedupe/tools/openssl-master/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/javds/Desktop/betterDedupe/tools/openssl-master/test/fips-and-base.cnf';
    shift;
